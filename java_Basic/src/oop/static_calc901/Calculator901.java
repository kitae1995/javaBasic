package oop.static_calc901;

public class Calculator901 {
    ...
    */
	...
	String color;
	//static String color; - > 계산기 색깔 다 통일할거면 static으로 하는게 편함
    ...
    */
	...
	public static double calcAreaCircle(int r) { // static을 붙였으니 Calculator901.calcAreaCircle로 바로 부를수있음
		return r*r*pi;
	}
}
