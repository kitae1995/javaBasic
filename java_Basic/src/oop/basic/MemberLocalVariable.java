...
public class MemberLocalVariable {
	...
	void printNumber(int c) { // 매개변수 역시 지역변수 
		int b = 1; //지역 변수
		System.out.println("멤버 변수 a는 " + a);
		System.out.println("지역 변수 b는 " + b);
		System.out.println("매개 변수 c는 " + c);
	}

	public static void main(String[] args) {
		
	MemberLocalVariable	m = new MemberLocalVariable(); // 이렇게 직접 클래스를 따오던지 , void 앞에 static을 붙여주던지 해야함
		m.printNumber(4);
	}
