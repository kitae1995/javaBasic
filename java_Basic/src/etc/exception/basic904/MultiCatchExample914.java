...
public class MultiCatchExample914 {
	...
	public static void main(String[] args) {
		...
		}catch(InputMismatchException | ArithmeticException e) {//오류난 곳만 막으려면 오류난 곳의 오류코드를 적어줘야함 이렇게
			System.out.println("정상적으로 입력해주세요"); // 이렇게 두개의 오류를 하나로 할수도 있음
