...
public class StrBuilderExample905 {
	...
	public static void main(String[] args) {
        ...
        */
		...
		StringBuilder sb = new StringBuilder("hello"); // string과 다르게 stringbulider는 이렇게 생성해야함
													   // 다시 재선언하면 되는 str과 다르게 여러 명령어를 써야함
